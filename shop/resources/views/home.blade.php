            ...
            @foreach($menus as $key => $menu)
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        ...
                        <a href="Product-detail" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                    ...
                    <div class="block2">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="product-detail/{{$dataPro->id}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                    {{$dataPro->name}}
                                </a>
